...
#define HSERIAL_RX NANO_GPIO_9
#define HSERIAL_TX NANO_GPIO_8
#define SERVER_BOARD_CONTROL_PIN NANO_GPIO_10
#define SENSOR_BOARD_CONTROL_PIN NANO_AI_3
